  ...
  return (
    <div className="">
      <div className="z-50 fixed top-0 left-0 w-full h-full flex flex-col items-center justify-center bg-black bg-opacity-50">
        ...
        <div className="z-50 bg-soki rounded-xl p-4 md:px-8 md:py-8 w-[350px] sm:w-[600px] md:w-[720px] xl:w-[64rem] md:max-w-3xl md:mx-auto">
          <div className="flex flex-col sm:flex-row bg-transparent">
            <div className="bg-transparent flex mx-auto justify-center sm:justify-start items-center sm:items-start">
              <Image 
                alt="hero"
                src="/hero-img.png"
                sizes="100vw"
