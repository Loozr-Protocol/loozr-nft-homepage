    ...
    <div className="z-10 block lg:flex bg-transparent text-transparent max-w-6xl mx-auto">
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="block lg:-mt-32 bg-transparent lg:w-[49%]">
          <h1 className="font-black bg-transparent text-3xl lg:text-[60px] leading-[4.6875rem]">Loozr AR Access <br className="hidden sm:inline" /> Card Collection.</h1>

          <div className="lg:flex pt-4 justify-between">
            <div className="md:mr-6">
              <button type="button" className="bluePink-gradient flex rounded-full items-center justify-center  w-[212px] h-[65px]">
