  ...
  return (
    <nav className="navbar navbar-expand-lg">
      <div className="container">
        ...
        <div className="!bg-transparent collapse navbar-collapse lg:block hidden " id="navbarSupportedContent">
          <ul className="!bg-transparent flex md:flex-row flex-col items-center !text-white gap-7 md:ml-auto">
            {/* <li className="nav-item">
              <a className="nav-link !font-medium " href="https://loozr-1.gitbook.io/docs/">
                LiteDoc
              </a>
            </li> */}
            <li className="!bg-transparent nav-item">
              <a className="!bg-transparent txt text-[14px] !font-medium  " href="/product">
                Products
              </a>
            </li>
            <li className="!bg-transparent nav-item">
              <a className="!bg-transparent txt text-[14px] !font-medium " target="_blank" href="https://docs.loozr.io/infrastructure/loozr-ecosystem">
                Ecosystem
              </a>
            </li>
            <li className="!bg-transparent nav-item">
              <a className="!bg-transparent txt text-[14px] !font-medium  " target="_blank" href="https://docs.loozr.io/infrastructure/loozr-applications">
                Applications
              </a>
            </li>
